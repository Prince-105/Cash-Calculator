const denominations = [
    { id: 'no500', value: 500, out: 'txt500' },
    { id: 'no200', value: 200, out: 'txt200' },
    { id: 'no100', value: 100, out: 'txt100' },
    { id: 'no50', value: 50, out: 'txt50' },
    { id: 'no20', value: 20, out: 'txt20' },
    { id: 'no10', value: 10, out: 'txt10' },
    { id: 'no1', value: 1, out: 'txt1' },
    { id: 'nocoin10', value: 10, out: 'txt1coin10' },
    { id: 'nocoin5', value: 5, out: 'txt1coin5' },
    { id: 'nocoin2', value: 2, out: 'txt1coin2' },
    { id: 'nocoin1', value: 1, out: 'txt1coin1' },
];
...
function toWords(num) {
  ...
  const parts = [];
  const scales = ['Crore', 'Lakh', 'Thousand', ''];
...
function updateTotals() {
  ...
  if (totalInWords) {
    totalInWords.textContent = toWords(total) + ' Rupees';
  }
}
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // USA option directly navigates to index1.html while keeping dropdown label behavior
  const usaOption = document.getElementById('usaOption');
  if (usaOption) {
    usaOption.addEventListener('click', (e) => {
      e.preventDefault();
      selectCountry('USA');
